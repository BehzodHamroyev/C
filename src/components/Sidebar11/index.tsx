...
const Sidebar11: React.FC<Sidebar11Props> = (props) => {
  ...
  return (
    <>
      ...
      >
        <Img
          className="h-[82px] md:ml-[0] ml-[19px] mr-[35px]"
        ...
        <Menu
          ...
          className="flex flex-col items-center justify-start mt-[99px] sm:pr-5 pr-[29px] w-full"
        >
          ...
          <Button
            className="bg-transparent cursor-pointer flex items-center justify-center min-w-[238px] mt-[200px]"
            leftIcon={
          ...
          <div className="flex flex-col gap-[33.82px] items-center justify-start mt-[30px] w-full">
