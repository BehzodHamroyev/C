...
const MoliyaHodimlarroyhatiTenPage: React.FC = () => {
    ...
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        ...
        <div className="absolute bg-blue_gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[18px] md:px-5 right-[2%] rounded-[5px] shadow-bs4 top-[10%] w-[79%]">
          ...
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start ml-24 md:ml-[0] w-[129px]"
            username="Oyna "
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start ml-1.5 md:ml-[0] w-[142px]"
            username="Komunal"
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start md:ml-[0] ml-[7px] w-[129px]"
            username="Soliqlar"
          />
          <OmborTaminotchigaZayavkaOneTab
...
export default MoliyaHodimlarroyhatiTenPage;
