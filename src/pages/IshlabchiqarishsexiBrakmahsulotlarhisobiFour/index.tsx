...
const IshlabchiqarishsexiBrakmahsulotlarhisobiFourPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-900 font-roboto h-[1055px] mx-auto pb-[155px] relative w-full">
        ...
        <Img
          ...
          alt="groupSeventySix"
        />
        <div className="absolute flex flex-col gap-[26px] items-start justify-start md:px-5 right-[0] top-[3%] w-[81%]">
          <div className="flex sm:flex-col flex-row md:gap-10 gap-[617px] items-start justify-start ml-0.5 md:ml-[0] w-[94%] md:w-full">
            <div className="bg-blue_gray-900 flex flex-col items-center justify-start sm:mt-0 mt-0.5 rounded-[5px] shadow-bs w-[24%] sm:w-full">
              <OmborTaminotchigaZayavkaOneTab
                className="flex flex-col items-center justify-start rounded-[5px] w-[254px]"
                username="1023"
              />
            </div>
            <div className="flex flex-row items-center justify-end w-[21%] sm:w-full">
          ...
          <div className="flex md:flex-col flex-row gap-[33px] items-center justify-between w-full">
            <div className="bg-blue_gray-900_87_01 flex md:flex-1 flex-col items-center justify-start mb-2.5 md:mt-0 mt-1 py-[22px] rounded-[5px] w-[97%] md:w-full">
              <div className="flex flex-col justify-start mb-1 w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between md:ml-[0] ml-[26px] w-[94%] md:w-full">
                  <div className="flex sm:flex-col flex-row gap-[21px] items-center justify-between mb-0.5 w-2/5 md:w-full">
                    <Img
                      className="h-[22px]"
                  ...
                  <Input
                    name="buttonsaqlash"
                    placeholder="yakunlash"
                    className="font-medium p-0 placeholder:text-blue-400 text-center text-sm tracking-[0.14px] uppercase w-full"
                    wrapClassName="border border-blue_gray-600 border-solid flex md:mt-0 mt-0.5 rounded-[5px] md:w-full"
                    suffix={
                      <Img
                        className="h-6 ml-5 my-auto"
                ...
                <div
                  className="bg-cover bg-no-repeat flex flex-col h-[458px] items-start justify-start mt-[25px] p-3 w-full"
                ...
                <div
                  className="bg-cover bg-no-repeat flex flex-col h-[37px] items-end justify-start md:ml-[0] ml-[421px] mt-[141px] p-1 w-[34%] md:w-full"
                  style={{
        ...
        <div className="absolute h-[60px] left-[0] md:px-5 top-[30%] w-1/5">
          <div className="absolute h-[60px] inset-[0] justify-center m-auto w-full">
            ...
            <div className="absolute bottom-[27%] flex flex-row gap-4 items-center justify-center left-[13%] w-[64%]">
              <Img
                className="h-6"
                src="images/img_user_white_a700_24x21.svg"
                alt="user"
              />
...
export default IshlabchiqarishsexiBrakmahsulotlarhisobiFourPage;
