...
const OmborBichishvarenderTwoPage: React.FC = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-roboto h-[1055px] mx-auto relative w-full">
        <div className="absolute md:h-[2745px] sm:h-[598px] h-[634px] inset-x-[0] max-w-[1400px] mx-auto md:px-5 top-[2%] w-full">
          <Img
          ...
          <div className="absolute bottom-[0] flex md:h-[2745px] h-[552px] sm:h-[598px] inset-x-[0] justify-end mx-auto w-full">
            ...
            <Img
              className="h-[415px] mb-[54px] ml-auto mt-auto"
              src="images/img_component6.svg"
              alt="componentSix"
            />
            <div className="absolute md:h-[2745px] h-[552px] sm:h-[598px] inset-y-[0] my-auto right-[0] w-[81%] md:w-full">
              <div className="absolute bg-blue_gray-900 flex flex-col md:gap-10 gap-[63px] h-full inset-[0] justify-center m-auto p-[11px] rounded-[5px] w-full">
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() => navigate("/omborbichishvarenderthree")}
                  >
                    <Text
                      className="bg-gray-900 h-[29px] justify-center pl-1.5 sm:pr-5 pr-[35px] py-[5px] rounded-bl-[3px] rounded-tl-[3px] text-base text-white-A700 w-16"
                      size="txtRobotoMedium16WhiteA700"
              ...
              <div className="absolute bottom-[0] md:h-[2745px] h-[487px] inset-x-[0] mx-auto w-full">
                ...
                <div className="absolute flex md:flex-col flex-row md:gap-5 h-full inset-[0] items-start justify-center m-auto py-[7px] w-[99%]">
                  ...
                  <div className="flex flex-col gap-[23px] items-center justify-start ml-12 md:ml-[0] md:mt-0 mt-0.5">
                    <Text
                      className="text-[15px] text-blue_gray-500"
                      size="txtRobotoMedium15Bluegray500"
                    >
...
export default OmborBichishvarenderTwoPage;
