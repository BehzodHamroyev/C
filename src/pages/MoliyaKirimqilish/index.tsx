...
const rustamjonFozilovOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];

const MoliyaKirimqilishPage: React.FC = () => {
                    ...
                    <div className="flex flex-col items-center justify-start w-[47%] md:w-full">
                      ...
                      <div className="flex flex-col justify-start mt-[21px] w-full">
                        ...
                        <SelectBox
                          ...
                          isMulti={false}
                          name="group305"
                          options={omborBichuvOptionsList}
                          isSearchable={false}
                          placeholder="Ombor & Bichuv"
                          shape="round"
                          color="gray_900_87"
                          size="xl"
                          variant="fill"
                    ...
                    <div className="flex flex-col items-center justify-start md:mt-0 mt-[3px] w-[47%] md:w-full">
                      <div className="flex flex-col items-start justify-start w-full">
                        ...
                        <SelectBox
                          ...
                          isMulti={false}
                          name="group302"
                          options={rustamjonFozilovOptionsList}
                          isSearchable={false}
                          placeholder="Rustamjon Fozilov"
                          shape="round"
                          color="gray_900_87"
                          size="2xl"
                          variant="fill"
                      ...
                      <div className="bg-gray-900_87 flex flex-col items-start justify-start mt-0.5 p-[11px] rounded-[3px] w-full">
                        <Text
                          className="mb-[45px] ml-2.5 md:ml-[0] text-[17px] text-gray-400 w-[87%] sm:w-full"
                          size="txtRobotoMedium17Gray400"
                        >
                          <>
                            Ombor bo\&#96;limi boshlig\&#96;iga barcha
                            ishchilarning oyligi berildi.
                          </>
                        </Text>
                      </div>
                    </div>
        ...
        <div className="absolute bg-blue_gray-800_7e flex flex-col gap-[30px] h-max inset-y-[0] justify-start left-[0] my-auto md:px-5 py-3 w-1/5">
          <div className="h-[60px] relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle1564_10.png"
              alt="rectangle1564"
            />
          </div>
          <Text
...
export default MoliyaKirimqilishPage;
