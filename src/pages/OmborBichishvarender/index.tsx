...
const OmborBichishvarenderPage: React.FC = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-roboto h-[1093px] mx-auto pr-0.5 py-0.5 relative w-full">
        <div className="absolute md:h-[2384px] sm:h-[598px] h-[649px] inset-x-[0] max-w-[1400px] mx-auto md:px-5 top-[2%] w-full">
          <Img
          ...
          <div className="absolute flex md:flex-col flex-row md:gap-5 items-start justify-start right-[2%] top-[0] w-[78%]">
            ...
            <div className="flex flex-row items-center justify-start ml-8 md:ml-[0] md:mt-0 mt-[5px] w-[21%] md:w-full">
          ...
          <div className="absolute bottom-[0] md:h-[2384px] h-[552px] sm:h-[598px] inset-x-[0] mx-auto w-full">
            <div className="absolute flex flex-col gap-[22px] justify-start left-[0] top-[28%] w-1/5">
              <div className="flex flex-row gap-[25px] items-center justify-start md:ml-[0] ml-[55px] w-[51%] md:w-full">
                <Img
              ...
              <div className="bg-blue_gray-900 flex flex-col items-center justify-start py-[13px] w-full">
                <div className="flex flex-col justify-start w-full">
                  ...
                  <Text
                    className="bg-blue_gray-500 h-[25px] justify-center mt-2.5 pb-1 sm:px-5 px-[35px] text-base text-white-A700 w-[275px]"
                    size="txtRobotoMedium16WhiteA700"
                  >
                    Bichish kartasi
                  </Text>
                  <Text
                    className="md:ml-[0] ml-[99px] mt-[7px] text-base text-blue_gray-500"
                    size="txtRobotoMedium16"
                  >
                    Qoldiqlar
                  </Text>
            ...
            <div className="absolute md:h-[2384px] h-[552px] sm:h-[598px] inset-y-[0] my-auto right-[0] w-[81%] md:w-full">
              <div className="absolute bg-blue_gray-900 flex flex-col md:gap-10 gap-[63px] h-full inset-[0] justify-center m-auto p-[11px] rounded-[5px] w-full">
                ...
                >
                  <div
                    className="common-pointer flex flex-row items-center justify-evenly w-full"
                    onClick={() => navigate("/omborbichishvarendertwo")}
                  >
                    <Text
              ...
              <div className="absolute bottom-[0] md:h-[2384px] h-[487px] inset-x-[0] mx-auto w-full">
                <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[0] w-full">
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between md:ml-[0] ml-[285px] mt-6 w-3/4 md:w-full">
                      <Line className="bg-blue_gray-800_01 h-px w-[24%]" />
                      <Line className="bg-blue_gray-800_01 h-px w-[63%]" />
                    </div>
                    ...
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between md:ml-[0] ml-[285px] mt-[25px] w-3/4 md:w-full">
                      <Line className="bg-blue_gray-800_01 h-px w-[24%]" />
                      <Line className="bg-blue_gray-800_01 h-px w-[63%]" />
                    </div>
                    ...
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between md:ml-[0] ml-[285px] mt-[22px] w-3/4 md:w-full">
                      <Line className="bg-blue_gray-800_01 h-px w-[24%]" />
                      <Line className="bg-blue_gray-800_01 h-px w-[63%]" />
                    </div>
                    <Line className="bg-blue_gray-800_01 h-0.5 mt-[38px] w-full" />
                    ...
                    <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between md:ml-[0] ml-[285px] mt-[23px] w-3/4 md:w-full">
                      <Line className="bg-blue_gray-800_01 h-px w-[24%]" />
                      <Line className="bg-blue_gray-800_01 h-px w-[63%]" />
                    </div>
                ...
                <div className="absolute flex md:flex-col flex-row md:gap-5 h-full inset-[0] items-start justify-center m-auto py-[7px] w-[97%]">
                  ...
                  <div className="flex flex-col items-center justify-start md:ml-[0] ml-[59px] md:mt-0 mt-0.5 w-[4%] md:w-full">
                  ...
                  <div className="flex flex-col items-center justify-start ml-7 md:ml-[0] md:mt-0 mt-0.5">
                    <Text
                      className="text-[15px] text-blue_gray-500"
                      size="txtRobotoMedium15Bluegray500"
                    >
                  ...
                  <div className="flex flex-col items-center justify-start md:ml-[0] ml-[35px] md:mt-0 mt-0.5">
                    <Text
                      className="text-[15px] text-blue_gray-500"
                      size="txtRobotoMedium15Bluegray500"
                    >
                  ...
                  <div className="flex flex-col items-center justify-start md:ml-[0] ml-[35px] md:mt-0 mt-[3px] w-[5%] md:w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <Text
                        className="text-[15px] text-blue_gray-500"
                        size="txtRobotoMedium15Bluegray500"
                  ...
                  <div className="flex flex-col items-center justify-start md:ml-[0] ml-[82px] md:mt-0 mt-[3px] w-[9%] md:w-full">
                    <div className="flex flex-col items-center justify-start w-full">
                      <Text
                        className="text-[15px] text-blue_gray-500"
                        size="txtRobotoMedium15Bluegray500"
        ...
        <div className="absolute bottom-[4%] h-[941px] md:px-5 right-[0] w-[1%]">
        ...
        <div className="absolute bottom-[4%] flex flex-col gap-2.5 justify-start md:px-5 right-[3%] w-[79%]">
          <Text
            className="md:ml-[0] ml-[13px] text-base text-white-A700"
            size="txtRobotoMedium16WhiteA700"
          >
            Aksesuarlar
          </Text>
          <div className="flex flex-col items-center justify-start w-full">
            ...
            >
              <div
                ...
                style={{ backgroundImage: "url('images/img_group242.svg')" }}
              >
                <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start mb-[62px] md:ml-[0] ml-[15px] w-[90%] md:w-full">
                  ...
                  <List
                    className="sm:flex-col flex-row md:gap-10 gap-[134px] grid sm:grid-cols-1 grid-cols-4 ml-28 md:ml-[0] md:mt-0 mt-[13px] w-[47%] md:w-full"
                    orientation="horizontal"
                  >
                    <div className="flex flex-col items-start justify-start w-full">
                      <Text
                  ...
                  <div className="flex flex-col items-center justify-start mb-[219px] md:ml-[0] ml-[54px] md:mt-0 mt-3.5">
                    <Text
                      className="text-[15px] text-blue_gray-500"
                      size="txtRobotoMedium15Bluegray500"
                    >
                  ...
                  <div className="flex flex-col items-center justify-start mb-[219px] md:ml-[0] ml-[72px] md:mt-0 mt-3.5">
                    <Text
                      className="text-[15px] text-blue_gray-500"
                      size="txtRobotoMedium15Bluegray500"
                    >
...
export default OmborBichishvarenderPage;
