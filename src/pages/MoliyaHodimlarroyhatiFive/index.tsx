...
const MoliyaHodimlarroyhatiFivePage: React.FC = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        <div className="md:h-[2738px] h-[900px] m-auto md:px-5 w-full">
          <Img
            className="h-[900px] m-auto object-cover w-full"
            src="images/img_showroombuyurtmalar.png"
            alt="globalOne"
          />
          <div className="absolute flex flex-col gap-3 inset-x-[0] justify-start mx-auto top-[3%] w-[95%]">
            ...
            <div className="md:h-[2431px] sm:h-[661px] h-[666px] md:ml-[0] ml-[226px] relative w-[84%] md:w-full">
              <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                <div className="flex flex-col md:gap-10 gap-[549px] items-center justify-start my-[5px] w-full">
        ...
        <div className="absolute bg-blue_gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[18px] md:px-5 right-[2%] rounded-[5px] shadow-bs4 top-[10%] w-[79%]">
          ...
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start md:ml-[0] ml-[61px] w-[142px]"
            username="Taminot"
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start ml-24 md:ml-[0] w-[127px]"
            username="oyna"
          />
          <List
...
export default MoliyaHodimlarroyhatiFivePage;
