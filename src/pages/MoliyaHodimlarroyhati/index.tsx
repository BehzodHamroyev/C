...
const MoliyaHodimlarroyhatiPage: React.FC = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        <div className="md:h-[2741px] h-[899px] m-auto md:px-5 w-full">
          <Img
            className="h-[899px] m-auto object-cover w-full"
            src="images/img_global1_12.png"
            alt="globalOne"
          />
              ...
              <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                <div className="flex flex-col md:gap-10 gap-[549px] items-center justify-start mb-2.5 mt-0.5 w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                    ...
                    <SelectBox
                      className="md:flex-1 font-medium leading-[normal] md:mt-0 my-[3px] text-base text-left w-[18%] md:w-full"
        ...
        <div className="absolute bg-blue_gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-start md:px-5 right-[2%] rounded-[5px] shadow-bs4 top-[10%] w-[79%]">
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start w-[142px]"
            username="Diller"
          />
          <div className="flex md:ml-[0] ml-[25px] relative w-1/4 md:w-full">
            <OmborTaminotchigaZayavkaOneTab
        ...
        <div className="absolute bottom-[31%] h-[60px] left-[0] md:px-5 w-1/5">
          ...
          <Img
            ...
            src="images/img_rectangle1564_32.png"
            alt="rectangle1564"
          />
        </div>
        ...
        <Button
          className="common-pointer bg-transparent bottom-[27%] cursor-pointer flex items-center justify-center left-[2%] mb-[247px] min-w-[211px] ml-[25px]"
...
export default MoliyaHodimlarroyhatiPage;
