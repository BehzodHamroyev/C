...
const OmborMahsulotqabuliAksesuarPage: React.FC = () => {
  return (
    <>
      <div
        className="bg-cover bg-gray-900 bg-no-repeat flex flex-col font-roboto h-[900px] items-center justify-end mx-auto pr-[18px] py-[18px] w-full"
        style={{ backgroundImage: "url('images/img_showroombuyurtmalar.png')" }}
      >
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly mt-2.5 mx-auto md:px-5 w-full">
                      ...
                      <div className="absolute flex flex-col inset-x-[0] items-end justify-start p-4 top-[0] w-full">
                        <div className="flex flex-row items-end justify-end mr-1 w-[88%] md:w-full">
                          <Img
                            ...
                            alt="fluentvehicle"
                          />
                          <Text className="ml-[17px] mt-1.5 uppercase">
                            yangi qabuli{" "}
                          </Text>
                          <Img
          ...
          <div className="flex flex-1 flex-col justify-start w-full">
            ...
            <Text
              className="md:ml-[0] ml-[9px] mt-5 text-2xl md:text-[22px] text-gray-400 sm:text-xl"
              ...
              <div className="flex flex-col items-center justify-start w-full">
                <div className="flex flex-col items-center justify-start w-full">
                  <div className="bg-blue_gray-900_87_01 flex flex-col items-center justify-start p-[30px] sm:px-5 rounded-[5px] shadow-bs6 w-full">
                    <div className="flex flex-col gap-[52px] items-center justify-start mb-[65px] w-[98%] md:w-full">
                      <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-[99%] md:w-full">
                        ...
                        <Input
                          ...
                          wrapClassName="border border-blue_gray-600 border-solid flex mb-[7px] rounded-[5px] md:w-full"
                          suffix={
                            <Img
...
export default OmborMahsulotqabuliAksesuarPage;
