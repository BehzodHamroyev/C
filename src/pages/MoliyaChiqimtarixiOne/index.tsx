...
const MoliyaChiqimtarixiOnePage: React.FC = () => {
  return (
    <>
      <div
      ...
      >
        <div className="absolute md:h-[2916px] sm:h-[665px] h-[791px] inset-x-[0] mx-auto md:px-5 top-[3%] w-full">
          ...
          <div className="absolute bottom-[0] flex md:h-[2916px] sm:h-[663px] h-[666px] justify-end right-[0] w-[83%] md:w-full">
            <Line className="bg-blue_gray-900 h-[52px] mb-[258px] ml-[287px] mt-auto w-px" />
            <div className="absolute md:h-[2916px] sm:h-[663px] h-[666px] inset-[0] justify-center m-auto w-full">
              <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                <div className="flex flex-col md:gap-10 gap-[542px] items-center justify-start mb-2.5 mt-1.5 w-[99%] md:w-full">
              ...
              >
                <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start w-[96%] md:w-full">
                  ...
                  <List
                    className="sm:flex-col flex-row md:gap-10 gap-[63px] grid grid-cols-2 ml-9 md:ml-[0] md:mt-0 mt-1 w-[23%] md:w-full"
                  ...
                  <List
                    className="sm:flex-col flex-row gap-[39px] grid grid-cols-2 mb-[53px] md:ml-[0] ml-[82px] md:mt-0 mt-1 w-1/5 md:w-full"
                    orientation="horizontal"
                  >
                    <div className="flex flex-col items-start justify-start w-full">
                      <Text
                  ...
                  <div className="flex flex-col items-center justify-start mb-1.5 md:ml-[0] ml-[50px] md:mt-0 mt-0.5 w-[9%] md:w-full">
                    <div className="flex flex-col items-start justify-start w-full">
                      <Text
                        className="text-[15px] text-blue_gray-500"
                        size="txtRobotoMedium15Bluegray500"
                  ...
                  <div className="flex flex-col items-center justify-start mb-[52px] md:ml-[0] ml-[55px] md:mt-0 mt-0.5 w-[14%] md:w-full">
                    <div className="flex flex-col items-start justify-start w-full">
                      <Text
                        className="text-[15px] text-blue_gray-500"
                        size="txtRobotoMedium15Bluegray500"
        ...
        <div className="absolute bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[7px] md:px-5 right-[2%] rounded-[5px] top-[10%] w-[79%]">
          <OmborTaminotchigaZayavkaOneTab className="flex flex-col items-center justify-start w-[135px]" />
...
export default MoliyaChiqimtarixiOnePage;
