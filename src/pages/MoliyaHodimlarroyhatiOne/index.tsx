...
const MoliyaHodimlarroyhatiOnePage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        ...
        <div className="absolute bottom-[12%] h-[632px] sm:h-[672px] md:h-[922px] md:px-5 right-[1%] w-4/5 md:w-full">
...
export default MoliyaHodimlarroyhatiOnePage;
