...
const MoliyaKirimqilishEightPage: React.FC = () => {
                    ...
                    <div className="flex flex-col items-center justify-start w-[47%] md:w-full">
                      <div className="flex flex-col justify-start w-full">
                        ...
                        <SelectBox
                          ...
                          isMulti={false}
                          name="group528"
                          options={soliqlarOptionsList}
                          isSearchable={false}
                          placeholder="Soliqlar"
                          shape="round"
                          color="gray_900_87"
                          size="xl"
                          variant="fill"
                      ...
                      <div className="flex flex-col justify-start mt-[21px] w-full">
                        ...
                        <SelectBox
                          ...
                          isSearchable={false}
                          placeholder=" “Davlat soliq ” qo&#96;mitasi"
                          shape="round"
                          color="gray_900_87"
                          size="xl"
                          variant="fill"
        ...
        <div className="absolute bg-blue_gray-800_7e flex flex-col gap-[30px] h-max inset-y-[0] justify-start left-[0] my-auto md:px-5 py-3 w-1/5">
          <div className="h-[60px] relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle1564_15.png"
              alt="rectangle1564"
            />
          </div>
          <Text
...
export default MoliyaKirimqilishEightPage;
