...
const RoyhatgaolishEightPage: React.FC = () => {
  return (
    <>
      <div
      ...
      >
        <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start max-w-[998px] mx-auto w-full">
            ...
            <div className="flex flex-col items-start justify-start mb-[13px] md:ml-[0] ml-[25px] w-[86%] md:w-full">
              ...
              <div className="flex h-14 md:h-[59px] justify-end mt-[27px] pt-3 relative w-full">
                <div className="h-[43px] mt-auto mx-auto w-full">
                  <div className="flex flex-col items-start justify-start mb-[-5.67px] mx-auto pb-[5px] pr-[5px] w-full z-[1]">
                    <Text
...
export default RoyhatgaolishEightPage;
