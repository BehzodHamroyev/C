...
const MoliyaChiqimtarixiSixPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        <div
          className="bg-cover bg-no-repeat md:h-[2917px] sm:h-[666px] h-[900px] m-auto p-7 md:px-5 w-full"
          style={{
        ...
        >
          ...
          <div className="absolute flex flex-col gap-[18px] items-center justify-start right-[2%] top-[3%] w-[79%]">
            ...
            <div className="bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[17px] rounded-[5px] w-full">
              <OmborTaminotchigaZayavkaOneTab
                ...
                username="Oylik "
              />
              <OmborTaminotchigaZayavkaOneTab className="flex flex-col items-center justify-start w-[142px]" />
              <OmborTaminotchigaZayavkaOneTab
                className="flex flex-col items-center justify-start w-[142px]"
                username="akfa"
              />
              <OmborTaminotchigaZayavkaOneTab
                className="flex flex-col items-center justify-start ml-2.5 md:ml-[0] w-[127px]"
                username="oyna"
              />
              <List
          ...
          <div className="absolute bottom-[9%] flex md:h-[2917px] h-[666px] justify-end right-[2%] w-[79%] md:w-full">
            <Line className="bg-blue_gray-900 h-[52px] mb-[258px] ml-[287px] mt-auto w-px" />
            <div className="absolute md:h-[2917px] h-[666px] inset-[0] justify-center m-auto w-full">
              ...
              >
                <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start w-[96%] md:w-full">
                  ...
                  <List
                    className="sm:flex-col flex-row md:gap-10 gap-[82px] grid grid-cols-3 mb-[53px] md:ml-[0] ml-[63px] md:mt-0 mt-1 w-[33%] md:w-full"
                    orientation="horizontal"
                  >
        ...
        <div className="absolute bg-blue_gray-800_7e flex flex-col gap-[22px] h-max inset-y-[0] items-center justify-end left-[0] my-auto md:px-5 py-[7px] w-1/5">
          ...
          <div className="h-[60px] relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle1564_20.png"
              alt="rectangle1564"
            />
          </div>
        </div>
...
export default MoliyaChiqimtarixiSixPage;
