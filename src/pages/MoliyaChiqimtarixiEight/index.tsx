...
const MoliyaChiqimtarixiEightPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        <div
          className="bg-cover bg-no-repeat md:h-[2924px] sm:h-[666px] h-[900px] m-auto p-7 md:px-5 w-full"
          style={{
        ...
        >
          ...
          <div className="absolute flex flex-col gap-[21px] items-center justify-start right-[2%] top-[3%] w-[79%]">
            ...
            <div className="bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[17px] rounded-[5px] w-full">
              <OmborTaminotchigaZayavkaOneTab
                ...
                username="Oylik"
              />
              <div className="flex md:ml-[0] ml-[7px] relative w-1/4 md:w-full">
                <OmborTaminotchigaZayavkaOneTab
                  className="flex flex-col items-center justify-start my-auto w-[142px]"
                  username="akfa "
                />
                <OmborTaminotchigaZayavkaOneTab
                  className="flex flex-col items-center justify-start ml-[-5px] my-auto w-[135px] z-[1]"
                  username="diller"
                />
              </div>
              <OmborTaminotchigaZayavkaOneTab
          ...
          <div className="absolute bottom-[9%] flex md:h-[2924px] h-[666px] justify-end right-[2%] w-[79%] md:w-full">
            <Line className="bg-blue_gray-900 h-[52px] mb-[258px] ml-[287px] mt-auto w-px" />
            <div className="absolute md:h-[2924px] h-[666px] inset-[0] justify-center m-auto w-full">
        ...
        <div className="absolute bg-blue_gray-800_7e flex flex-col gap-[22px] h-max inset-y-[0] items-center justify-end left-[0] my-auto md:px-5 py-[7px] w-1/5">
          ...
          <div className="h-[60px] relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle1564_18.png"
              alt="rectangle1564"
            />
          </div>
        </div>
...
export default MoliyaChiqimtarixiEightPage;
