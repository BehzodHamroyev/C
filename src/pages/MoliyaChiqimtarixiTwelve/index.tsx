...
const MoliyaChiqimtarixiTwelvePage: React.FC = () => {
      ...
      >
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto md:px-5 top-[3%] w-full">
          <div className="flex md:flex-col flex-row gap-[22px] items-start justify-between w-full">
            ...
            <div className="flex flex-1 flex-col md:gap-10 gap-[86px] items-center justify-start w-full">
              ...
              <div className="sm:h-[1124px] md:h-[1934px] h-[666px] relative w-full">
                <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                  <div className="flex flex-col justify-start mb-2.5 mt-1 w-[99%] md:w-full">
                    <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                      ...
                      <SelectBox
                        className="md:flex-1 font-medium leading-[normal] mb-1.5 md:ml-[0] ml-[249px] text-base text-left w-[19%] md:w-full"
                    ...
                    <div className="flex sm:flex-col flex-row gap-12 items-start justify-start md:ml-[0] ml-[189px] mt-[34px] w-[47%] md:w-full">
                      <List
        ...
        <div className="absolute bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[7px] md:px-5 right-[2%] rounded-[5px] top-[10%] w-[79%]">
          ...
          <div className="flex ml-2 md:ml-[0] relative w-[24%] md:w-full">
            ...
            />
            <OmborTaminotchigaZayavkaOneTab
              className="flex flex-col items-center justify-start ml-[-7px] my-auto w-[133px] z-[1]"
              username="Umumiy"
            />
          </div>
        </div>
...
export default MoliyaChiqimtarixiTwelvePage;
