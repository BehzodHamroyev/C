...
const MoliyaChiqimtarixiThirteenPage: React.FC = () => {
    ...
    <>
      ...
      >
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto md:px-5 top-[3%] w-full">
          <div className="flex md:flex-col flex-row gap-[22px] items-start justify-between w-full">
            ...
            <div className="flex flex-1 flex-col md:gap-10 gap-[86px] items-center justify-start w-full">
              ...
              <div className="md:h-[1933px] sm:h-[2201px] h-[666px] relative w-full">
                <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                  <div className="flex flex-col justify-start mb-2.5 mt-1.5 w-[99%] md:w-full">
                    ...
                    <div className="flex sm:flex-col flex-row gap-12 items-start justify-start md:ml-[0] ml-[219px] mt-[30px] w-1/2 md:w-full">
                      <List
                        className="sm:flex-col flex-row md:gap-10 gap-[118px] grid sm:grid-cols-1 grid-cols-3 w-3/4 sm:w-full"
                      ...
                      <div className="flex flex-col items-center justify-start w-[17%] sm:w-full">
                        <div className="flex flex-col items-start justify-start w-full">
                          <Text
                    ...
                    <div
                      className="bg-cover bg-no-repeat flex flex-col h-[37px] items-end justify-start md:ml-[0] ml-[349px] mt-[39px] p-1 w-[35%] md:w-full"
                      style={{
                        backgroundImage:
                ...
                >
                  <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start w-[96%] md:w-full">
                    ...
                    <div className="flex flex-col items-center justify-start mb-[52px] md:ml-[0] ml-[645px] md:mt-0 mt-0.5 w-[14%] md:w-full">
                      <div className="flex flex-col items-start justify-start w-full">
                        <Text
                          className="text-[15px] text-blue_gray-500"
                          size="txtRobotoMedium15Bluegray500"
                    ...
                    <div className="flex flex-col gap-[33px] items-center justify-start mb-[58px] md:ml-[0] ml-[25px] w-[7%] md:w-full">
                      <Text
        ...
        <div className="absolute bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[7px] md:px-5 right-[2%] rounded-[5px] top-[9%] w-[79%]">
          ...
          />
          <List
            className="sm:flex-col flex-row gap-2 grid grid-cols-2 ml-3.5 md:ml-[0] w-[24%] md:w-full"
            orientation="horizontal"
          >
            <OmborTaminotchigaZayavkaOneTab
          ...
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start ml-1 md:ml-[0] w-[142px]"
            username="offis"
          />
          <OmborTaminotchigaZayavkaOneTab
...
export default MoliyaChiqimtarixiThirteenPage;
