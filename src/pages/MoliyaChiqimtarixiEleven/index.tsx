...
const MoliyaChiqimtarixiElevenPage: React.FC = () => {
      ...
      >
        <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto md:px-5 top-[3%] w-full">
          <div className="flex md:flex-col flex-row gap-[22px] items-start justify-between w-full">
            <Sidebar4 className="!sticky !w-[217px] flex h-screen md:hidden justify-start md:mt-0 mt-[27px] overflow-auto top-[0]" />
            <div className="flex flex-1 flex-col md:gap-10 gap-[86px] items-center justify-start w-full">
              ...
              <div className="md:h-[2917px] sm:h-[663px] h-[666px] relative w-full">
                <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                  <div className="flex flex-col md:gap-10 gap-[543px] items-center justify-start mb-2.5 mt-1.5 w-[99%] md:w-full">
                    <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
                      <div className="flex md:flex-1 sm:flex-col flex-row gap-[21px] items-center justify-between md:mt-0 mt-0.5 w-[39%] md:w-full">
                        <Img
                          className="h-[22px]"
                      ...
                      <div className="flex md:flex-1 sm:flex-col flex-row gap-[26px] items-center justify-between w-[39%] md:w-full">
                        <SelectBox
                          className="font-medium leading-[normal] text-base text-left w-[47%] sm:w-full"
                ...
                >
                  <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start w-[96%] md:w-full">
                    ...
                    <List
                      className="sm:flex-col flex-row gap-[38px] grid grid-cols-2 ml-9 md:ml-[0] md:mt-0 mt-[3px] w-1/4 md:w-full"
                    ...
                    <div className="flex flex-col items-start justify-start mb-[54px] md:ml-[0] ml-[57px] md:mt-0 mt-1">
                      <Text
                        className="text-[15px] text-blue_gray-500"
                        size="txtRobotoMedium15Bluegray500"
                      >
                    ...
                    <List
                      className="sm:flex-col flex-row gap-[23px] grid grid-cols-2 mb-1.5 md:ml-[0] ml-[22px] md:mt-0 mt-[3px] w-[27%] md:w-full"
                      orientation="horizontal"
                    >
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="flex flex-col items-start justify-start w-full">
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[30px] w-1/2 md:w-full">
                            <Img
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[33px] w-[45%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_One"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[33px] w-1/2 md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Two"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[35px] w-[57%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Three"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[37px] w-[62%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Four"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[34px] w-[57%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Five"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-8 w-[57%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Six"
                          ...
                          <div className="flex flex-row gap-2.5 items-center justify-start mt-[35px] w-[57%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Seven"
                      ...
                      <div className="flex flex-col items-center justify-start w-full">
                        <div className="flex flex-col items-start justify-start w-full">
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[30px] w-[57%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[33px] w-[51%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_One"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[33px] w-[57%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Two"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[35px] w-[65%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Three"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[37px] w-[70%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Four"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-[34px] w-[65%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Five"
                          ...
                          <div className="flex flex-row gap-2.5 items-start justify-start mt-8 w-[65%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Six"
                          ...
                          <div className="flex flex-row gap-2.5 items-center justify-start mt-[35px] w-[65%] md:w-full">
                            <Img
                              className="h-[15px] w-[15px]"
                              src="images/img_vector_gray_400.svg"
                              alt="vector_Seven"
                    ...
                    <div className="flex flex-col items-center justify-start mb-[52px] md:ml-[0] ml-[47px] md:mt-0 mt-0.5 w-[14%] md:w-full">
                      <div className="flex flex-col items-start justify-start w-full">
                        <Text
                          className="text-[15px] text-blue_gray-500"
                          size="txtRobotoMedium15Bluegray500"
                    ...
                    <div className="flex flex-col gap-[33px] items-center justify-start mb-[58px] md:ml-[0] ml-[49px] w-[7%] md:w-full">
                      <Text
        ...
        <div className="absolute bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[7px] md:px-5 right-[3%] rounded-[5px] top-[9%] w-[79%]">
          ...
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start md:ml-[0] ml-[9px] w-[127px]"
            username="oyna"
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start ml-3.5 md:ml-[0] w-[129px]"
            username="komunal "
          />
          <OmborTaminotchigaZayavkaOneTab
...
export default MoliyaChiqimtarixiElevenPage;
