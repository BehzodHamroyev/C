...
const MoliyaChiqimtarixiFourteenPage: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="absolute md:h-[2921px] sm:h-[665px] h-[791px] inset-x-[0] mx-auto md:px-5 top-[3%] w-full">
          ...
          <div className="absolute bottom-[0] flex md:h-[2921px] sm:h-[659px] h-[666px] justify-end right-[0] w-[83%] md:w-full">
            <Line className="bg-blue_gray-900 h-[52px] mb-[258px] ml-[287px] mt-auto w-px" />
            <div className="absolute md:h-[2921px] sm:h-[659px] h-[666px] inset-[0] justify-center m-auto w-full">
              <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                <div className="flex flex-col justify-start mb-2.5 mt-1 w-[99%] md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                    ...
                    <SelectBox
                      className="md:flex-1 font-medium leading-[normal] mb-1.5 md:ml-[0] ml-[254px] text-base text-left w-[19%] md:w-full"
                    ...
                    />
                    <SelectBox
                      className="md:flex-1 font-medium leading-[normal] mb-1.5 md:ml-[0] ml-[26px] text-base text-left w-[19%] md:w-full"
                      placeholderClassName="text-gray-400"
                      indicator={
                        <Img
                          className="h-[3px] mr-[0] outline-gray-400 outline-[0.5px] outline w-[7px]"
                  ...
                  <div className="flex flex-col items-start justify-start md:ml-[0] ml-[245px] mt-9">
                    <Text
                  ...
                  <div
                    className="bg-cover bg-no-repeat flex flex-col h-[37px] items-end justify-start md:ml-[0] ml-[354px] mt-[87px] p-1 w-[35%] md:w-full"
                    style={{
              ...
              >
                <div className="flex md:flex-col flex-row md:gap-5 items-end justify-start mb-[3px] w-[96%] md:w-full">
                  <div className="flex flex-col items-start justify-start md:mt-0 my-14">
                    <Text
                  ...
                  <div className="flex flex-col items-start justify-start ml-9 md:ml-[0] md:mt-0 mt-2">
                    <Text
                      className="text-[15px] text-blue_gray-500"
                      size="txtRobotoMedium15Bluegray500"
                    >
                  ...
                  <div className="flex flex-col items-start justify-start mb-[55px] md:ml-[0] ml-[285px]">
                    <Text
                      className="text-[15px] text-blue_gray-500"
                      size="txtRobotoMedium15Bluegray500"
                    >
                  ...
                  <div className="flex flex-col items-center justify-start md:ml-[0] ml-[118px] md:mt-0 my-1.5 w-[9%] md:w-full">
                  ...
                  <div className="flex flex-col items-center justify-start mb-[52px] md:ml-[0] ml-[71px] md:mt-0 mt-1.5 w-[14%] md:w-full">
                    <div className="flex flex-col items-start justify-start w-full">
                      <Text
                        className="text-[15px] text-blue_gray-500"
                        size="txtRobotoMedium15Bluegray500"
                  ...
                  <div className="flex flex-col gap-[33px] items-center justify-start mb-[58px] md:ml-[0] ml-[23px] md:mt-0 mt-[3px] w-[7%] md:w-full">
                    <Text
        ...
        <div className="absolute bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[7px] md:px-5 right-[2%] rounded-[5px] top-[9%] w-[79%]">
          ...
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start md:ml-[0] ml-[7px] w-[142px]"
            username="komunal"
          />
          <OmborTaminotchigaZayavkaOneTab
...
export default MoliyaChiqimtarixiFourteenPage;
