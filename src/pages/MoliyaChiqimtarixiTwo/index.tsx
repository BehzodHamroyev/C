...
const MoliyaChiqimtarixiTwoPage: React.FC = () => {
        ...
        >
          <div className="flex md:flex-col flex-row gap-[5px] items-start justify-start mb-[51px] mx-auto md:px-5 w-full">
            ...
            <div className="flex flex-1 flex-col items-center justify-start w-full">
              ...
              <div className="bg-blue_gray-800_7e border border-blue_gray-400_7e border-solid flex md:flex-col flex-row md:gap-5 items-center justify-end mt-[23px] pl-[17px] rounded-[5px] w-full">
                ...
                <div className="h-12 md:h-[42px] ml-1 md:ml-[0] relative w-[24%] md:w-full">
                  <OmborTaminotchigaZayavkaOneTab
                    className="absolute flex flex-col h-max inset-y-[0] items-center justify-start left-[0] my-auto w-[142px]"
                    username="offis"
                  />
                  <OmborTaminotchigaZayavkaOneTab
                    className="absolute flex flex-col h-full inset-y-[0] items-center justify-start my-auto right-[0] w-[126px]"
                    username="Umumiy"
                  />
                </div>
              </div>
              <div className="md:h-[1948px] sm:h-[2217px] h-[666px] mt-[15px] relative w-full">
                <div className="absolute bg-blue_gray-900_87_01 flex flex-col h-full inset-[0] items-center justify-center m-auto p-[13px] rounded-[5px] w-full">
                  <div className="flex flex-col gap-9 justify-start mb-[86px] mt-0.5 w-full">
                    ...
                    <div className="flex sm:flex-col flex-row gap-12 items-start justify-start md:ml-[0] ml-[230px] w-1/2 md:w-full">
                      <List
        ...
        <div className="absolute bg-blue_gray-800_7e flex flex-col gap-[22px] h-max inset-y-[0] items-center justify-end left-[0] my-auto md:px-5 py-[7px] w-1/5">
          ...
          <div className="h-[60px] relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle1564_24.png"
              alt="rectangle1564"
            />
          </div>
        </div>
...
export default MoliyaChiqimtarixiTwoPage;
