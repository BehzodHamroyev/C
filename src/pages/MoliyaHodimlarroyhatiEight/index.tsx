...
const MoliyaHodimlarroyhatiEightPage: React.FC = () => {
    ...
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        ...
        <div className="absolute bg-blue_gray-900 flex md:flex-col flex-row md:gap-5 items-center justify-end pl-[18px] md:px-5 right-[2%] rounded-[5px] shadow-bs4 top-[10%] w-[79%]">
          ...
          />
          <OmborTaminotchigaZayavkaOneTab
            className="flex flex-col items-center justify-start md:ml-[0] ml-[63px] w-[142px]"
            username="Oyna"
          />
          <List
            className="sm:flex-col flex-row gap-2 grid grid-cols-2 md:ml-[0] ml-[38px] w-[24%] md:w-full"
            orientation="horizontal"
          >
            <OmborTaminotchigaZayavkaOneTab
...
export default MoliyaHodimlarroyhatiEightPage;
