...
const offisOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];
const offisUchunHarajatlarOptionsList = [
  { label: "Option1", value: "option1" },
  { label: "Option2", value: "option2" },
  { label: "Option3", value: "option3" },
];
...
const MoliyaKirimqilishTwoPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        <div
          className="bg-cover bg-no-repeat md:h-[1025px] sm:h-[745px] h-[900px] m-auto p-[29px] md:px-5 w-full"
          style={{
        ...
        >
          ...
          <div className="absolute bottom-[6%] flex md:h-[1025px] sm:h-[745px] h-[747px] justify-end right-[3%] w-[79%] md:w-full">
                ...
                <div className="bg-blue_gray-900_87_01 flex flex-col items-start justify-start p-[33px] sm:px-5 rounded-[5px] shadow-bs6 w-full">
                  <div className="flex md:flex-col flex-row md:gap-10 gap-[69px] items-start justify-start mb-[155px] md:ml-[0] ml-[13px] w-[93%] md:w-full">
                    <div className="flex flex-col items-center justify-start w-[47%] md:w-full">
                      ...
                      <div className="flex flex-col justify-start mt-[21px] w-full">
                        ...
                        <SelectBox
                          ...
                          isMulti={false}
                          name="group349"
                          options={offisUchunHarajatlarOptionsList}
                          isSearchable={false}
                          placeholder="Offis uchun harajatlar"
                          shape="round"
                          color="gray_900_87"
                          size="xl"
                          variant="fill"
                    ...
                    <div className="flex flex-col items-center justify-start md:mt-0 mt-[3px] w-[47%] md:w-full">
                      ...
                      <div className="bg-gray-900_87 flex flex-col items-start justify-start mt-0.5 p-2.5 rounded-[3px] w-full">
                        <Text
                          className="mb-[100px] ml-2.5 md:ml-[0] text-[17px] text-gray-400"
                          size="txtRobotoMedium17Gray400"
                        >
                          12 ta kreslo $ 120 sotib olindi
                        </Text>
                      </div>
                    </div>
                  </div>
        ...
        <div className="absolute bg-blue_gray-800_7e flex flex-col gap-[30px] h-max inset-y-[0] justify-start left-[0] my-auto md:px-5 py-3 w-1/5">
          <div className="h-[60px] relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle1564_16.png"
              alt="rectangle1564"
            />
          </div>
          <Text
...
export default MoliyaKirimqilishTwoPage;
