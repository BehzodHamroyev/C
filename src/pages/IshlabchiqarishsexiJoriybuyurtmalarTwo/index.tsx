...
const IshlabchiqarishsexiJoriybuyurtmalarTwoPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        <div className="absolute md:h-[1348px] h-[899px] inset-[0] justify-center m-auto md:px-5 w-full">
          <div className="h-[899px] m-auto w-full">
            <div className="h-[899px] m-auto w-full">
              <Img
                ...
                alt="globalOne"
              />
              <div className="absolute flex flex-col md:gap-10 gap-[249px] justify-start left-[0] top-[3%] w-[96%]">
            ...
            <div className="absolute bg-blue_gray-500 bottom-[42%] h-[41px] left-[0] w-1/5"></div>
          </div>
          <div className="absolute bottom-[4%] flex md:flex-col flex-row gap-[30px] inset-x-[0] items-center justify-start mx-auto w-[95%]">
            <div className="flex flex-row gap-[27px] items-start justify-between w-[16%] md:w-full">
              <Img
                className="h-[15px]"
              ...
              <div className="flex flex-col items-center justify-start">
                <div className="flex flex-col items-start justify-start w-full">
                  ...
                  <Text
                    className="mt-6 text-base text-white-A700"
                    size="txtRobotoMedium16WhiteA700"
                  >
                    Guruhlar kvadrati
                  </Text>
            ...
            <div className="bg-blue_gray-900_87_01 flex flex-col justify-start py-[22px] rounded-[5px] w-[83%] md:w-full">
              ...
              <div
                className="bg-cover bg-no-repeat flex flex-col h-[458px] items-start justify-start mt-7 p-3 w-full"
                style={{ backgroundImage: "url('images/img_group664.svg')" }}
              >
                <List
                  className="sm:flex-col flex-row gap-[18px] grid sm:grid-cols-1 md:grid-cols-5 grid-cols-9 mb-1 md:ml-[0] ml-[7px] w-[93%]"
                ...
                >
                  ...
                  <div className="flex flex-col items-start justify-start w-full">
                    ...
                    <Text
                      className="mt-9 text-[15px] text-blue-400"
                      size="txtRobotoMedium15Blue400"
                    >
                      Soyif
                    </Text>
...
export default IshlabchiqarishsexiJoriybuyurtmalarTwoPage;
