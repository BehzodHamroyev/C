...
const ShowroomIshlabchiqarishdaPage: React.FC = () => {
    ...
    <>
      <div className="bg-gray-900 font-roboto h-[900px] mx-auto relative w-full">
        <div className="md:h-[3178px] sm:h-[899px] h-[900px] m-auto md:px-5 w-full">
                    ...
                    <div className="flex flex-col items-center justify-start w-full">
                      ...
                      <div className="md:h-[2405px] h-[500px] sm:h-[511px] mt-[11px] relative w-full">
                        <div className="absolute md:h-[485px] h-[495px] inset-[0] justify-center m-auto w-full">
                          <div className="absolute flex flex-col gap-[21px] h-full inset-y-[0] justify-start my-auto right-[26%] w-[5%]">
                            <Text
          ...
          <div className="absolute bg-blue_gray-800_7e flex flex-col items-center justify-start left-[0] py-[19px] top-[29%] w-1/5">
            ...
            <Text
              className="mt-[29px] text-blue_gray-500 text-sm"
              size="txtRobotoMedium14"
            >
              Yangi buyurtma yaratish
            </Text>
            <div className="h-[60px] md:h-[76px] mt-4 relative w-full">
              <div className="absolute bg-blue_gray-800_7e flex flex-col h-full inset-[0] items-start justify-center m-auto p-5 w-full">
                <Text
                  className="md:ml-[0] ml-[67px] mt-0.5 text-sm text-white-A700"
              ...
              <Img
                ...
                src="images/img_rectangle1564_3.png"
                alt="rectangle1564"
              />
            </div>
            <div className="flex flex-col gap-[22px] items-start justify-start mb-0.5 mt-[15px]">
              <Text
                className="text-blue_gray-500 text-sm"
                size="txtRobotoMedium14"
              >
...
export default ShowroomIshlabchiqarishdaPage;
